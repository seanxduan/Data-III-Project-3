...
Initially, my garbage time variable was a simple ratio of differential divided by time remaining. I graphed this variable and as you can see from the boxplot and histogram above, it was an extremely right skewed distribution. There was a great deal of plays with a 0 or near 0 garbage time score, and a 'straggling tail' of extreme outliers with much larger garbage time values.
