...
```{r Joes Analysis, include = FALSE, echo = F}
...
plays.test = read.csv("c:/Users/JoeCo/Documents/GitHub/Data-III-Project-3/Data/NFL_Test.csv")
plays.train = read.csv("c:/Users/JoeCo/Documents/GitHub/Data-III-Project-3/Data/NFL_Train.csv")
...
=======
So, now we have ten different models, each built from the subset of data from each of the top ten defensive personnel units. 
